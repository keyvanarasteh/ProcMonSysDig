...
_(Not: Sysdig programında toplam **400'den fazla** alt alan (field) mevcuttur. Eğer özel bir senaryo gerekiyorsa terminalinizden `sysdig -l` yazarak anında tüm listeye İngilizce açıklamalarıyla beraber ulaşabilirsiniz!)_
