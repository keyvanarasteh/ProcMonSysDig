...
- [x] **GraphView Süreç Seçimi**: `treeData` ve `GraphTransformer` verilerini birleştirip SvelteKit GraphCanvas süreç seçici komponentini tamamen doldur.
- [x] **Bugfix & Checkup**: `GraphCanvas.svelte`'deki boş listeyi giderme ve ProcDot tarzı süreç izolasyon modunu deneme.
